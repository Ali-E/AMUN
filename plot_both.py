...
if __name__ == '__main__':
    ...
    fig, ax = sb.mpl.pyplot.subplots(1, 4, figsize=(16.5, 4))
    ...
    for idx, filename in enumerate(filenames):
        ...
        for i_, val in enumerate(vals):
            ...
            z = ax[idx*2 + i_]
            # if idx == 0:
            z.set_ylabel(names[i_], fontsize=14)
            # z.legend_.remove()
            # z.get_legend().remove()
    ...
    plt.savefig(f'ablation_plots/fancy_both_adaptive.png')
