...
parser.add_argument('--up_sample', default=1, type=int)
            ...
            for unlearn_count in unlearn_count_list:
                for seed in seed_list:
                    try:
                        ...
                        if job_type == 'unlearn':
                            command = f"sbatch unlearn_job_submit.slurm {dataset} {method} {model} {mode} {seed} {filter_method} {unlearn_count} {score_path} {args.up_sample}"
                        elif job_type == 'train':
